...
<head>
    ...
    <title>Réinitialiser le mot de passe - Dokita</title>
    ...
    <div style="padding-top:72px;">
        <div class="split-layout">
            ...
            <div class="left-side">
                ...
                <p>Choisissez un nouveau mot de passe robuste et sécurisé pour protéger vos données de santé.</p>
            </div>
                ...
                <div class="form-container">
                    ...
                    <form method="POST" action="{{ route('password.store') }}">
                        ...
                        <div class="field-group">
                            ...
                            <input type="email" id="email" name="email" value="{{ old('email', $request->email) }}" class="form-input" placeholder="votre@email.com" required readonly>
                        </div>
